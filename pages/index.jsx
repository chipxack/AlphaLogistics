      ...
      <section className="md:py-20 | relative | overflow-y-hidden">
        ...
        <div className="relative | px-5 md:pb-7 container mx-auto z-50">
          ...
          <div className="grid grod-cols-1 md:grid-cols-4 space-y-3 md:space-y-0">
            <div className="md:col-span-1 | fb_vertically | p-4 space-y-5 | border border-gray-100 | cursor-pointer | group hover:bg-orange-primary duration-200">
              <div>
            ...
            <div className="md:col-span-2 | flex md:flex-row flex-col | p-4 | border border-gray-100 | cursor-pointer | group hover:bg-orange-primary duration-200">
              ...
              <Link key={idx} href={`/products/${product.slug}`}>
                ...
                >
                  <div className="h-64 overflow-hidden | relative">
                    ...
                    <div className="p-2 top-0 left-0 ml-2 mt-2 | text-xs | absolute | bg-gray-200/90 | rounded-md">
