        ...
        <App className="relative">
            <section className="2xl:h-auto overflow-x-hidden bg-[#000000] | relative">
                ...
                <div className="fcc box-border pb-5 md:px-5 md:pr-10">
                    <div
                        className="w-full lg:max-w-[1600px] mx-auto fcc h-64 md:h-[500px] overflow-hidden relative z-10">
                        <video muted={true} style={{width: '100%'}} src="/video-back.mp4" autoPlay={true}
                        ...
                        >
                            {[
                                ...
                                <Link href={link.href} key={`menu__link__${index}`}>
                                    ...
                                    >
                                        <div
                                            className="md:inline-flex flex items-center justify-between md:justify-center px-2 md:space-x-4 absolute inset-0">
                            ...
                            <div
                                id="bgbg"
                                className="absolute opacity-0 group-hover:opacity-70 left-0 -mt-5 h-[3rem] blur-lg w-1/3 md:w-1/4 md:h-[10rem] md:blur-2xl duration-500 md:rounded-[50%] bg-orange-primary"
                            ></div>
                        </ul>
                    </div>
                </div>
                ...
                <div className="container mx-auto | px-5 py-10 md:py-12 | fc flex-col md:flex-row  | font-exo">
                    <div className="w-full md:w-1/5 | md:space-y-3  md:flex-col flex justify-between items-">
                        ...
                        <button className="inline-flex items-center | space-x-4 group">
                            <p className="text-[#FFCC00] md:text-base text-sm">Read more</p>
                    ...
                    <div className="w-full md:w-4/5 text-white text-opacity-70 | space-y-7">
                        <p className="font-inter text-xs md:text-base pt-8">
                            AlphaTradeLogistics is an international operating global company.
                            After having almost a decade of experience in sales, import and
                            export spheres, our company proudly becomes a part of AlphaTrade.
                            This gave us a great deal of opportunities and prospective
                            development plan.
                        </p>
                        ...
                        <ul className="flex justify-between md:space-x-44">
                            <li>
                                <div
                                    className="flex items-center justify-between flex-col md:flex-row md:space-x-5 space-y-2 md:space-y-0">
                                    <svg
            ...
            <section className="bg-[#000000] | px-5 md:py-20 | relative | overflow-y-hidden">
                                ...
                                <AccordionItem>
                                    <li className="flex-col | py-7 ml-1 md:ml-7 | text-white | border-y border-gray-400/25">
                                        <AccordionItemHeading>
                                            <AccordionItemButton>
                                                <div
                                                    className="font-exo md:text-lg | flex items-center | w-full space-x-3">
                ...
                {/* <div className='bounce md:w-[35rem] md:h-[30rem] w-[25rem] h-[25rem] opacity-50 md:opacity-[72%] absolute -bottom-48 -left-56 | blur-2xl duration-150 rounded-[50%] bg-orange-primary'></div> */}
            </section>
            ...
            <section className="relative | overflow-y-hidden py-5 md:pt-20">
                ...
                <div className="relative | container mx-auto z-50">
                    <h3
                        id="howwework"
                        className="relative | text-[#020105] px-5 md:px-0 font-gm text-2xl font-extrabold pb-7"
                    >
                        How we work
                    </h3>
                ...
                <div
                    className="w-full mt-10 md:mt-16 rounded-l-md"
                    style={{
                        paddingLeft:
            ...
            <section className="py-5 md:py-20 | relative | overflow-y-hidden">
                ...
                <div className="relative | container mx-auto z-50">
                    <h3
                        id="landmark"
                        className="relative| px-5 md:pb-7 md:px-0 | text-[#020105] font-gm text-2xl font-extrabold"
                    >
                ...
                <div className="relative | px-5 md:pb-7 container mx-auto z-50">
                    ...
                    <div className="grid grod-cols-1 md:grid-cols-4 space-y-3 md:space-y-0">
                        ...
                        <div
                            ...
                            <div
                                className="w-full aspect-square object-center md:w-1/2 md:h-[35rem] | rounded-md overflow-hidden">
                                <img
                                    src="/man.png"
                                    alt="man_image"
                                    className="object-cover h-full w-full"
            ...
            <section className="relative py-20 md:py-0 md:pb-20 | overflow-y-hidden">
                <div className="relative | px-5 container mx-auto z-50">
                    <h3
                        id="products"
                        className="relative | text-[#020105] font-gm text-2xl font-extrabold pb-5 md:pb-7"
                    >
                        Products
                    </h3>
                    ...
                    <div className="flex md:items-center md:justify-between flex-col md:flex-row">
                        ...
                        <button className="inline-flex items-center | space-x-4 group">
                            <Link href={`/products`} className="text-[#FFCC00]">
                                <p className="text-[#FFCC00]">Show Catalog</p>
                            </Link>
                            ...
                            <Link key={idx} href={`/products/${product.slug}`}>
                                ...
                                >
                                    <div className="h-64 overflow-hidden | relative">
                                        ...
                                        <div
                                            className="p-2 top-0 left-0 ml-2 mt-2 | text-xs | absolute | bg-gray-200/90 | rounded-md">
                                    ...
                                    <div className="product__info | py-5 px-5 space-y-3">
                                        ...
                                        <div
                                            className="text-[#5D5D5F] text-sm cut-text"
                                        ...
                                        <button className="inline-flex items-center | space-x-4 group">
                                            <p className="text-[#FFCC00] text-base">Details</p>
            ...
            <section className="py-5 md:py-20 | relative | overflow-y-hidden bg-[#000000]">
                ...
                <div className="relative | px-5 container mx-auto z-50">
                    <div className="fcb pt-5 pb-7">
                        ...
                        >
                            <Link href={`/news`}>
                                <p className="text-[#FFCC00]">Show all news</p>
                            </Link>
                            ...
                            <Link key={idx} href={`/news/${n.slug}`}>
                                ...
                                >
                                    <div className="space-y-2 w-full">
                                        ...
                                        <div
                                            className="text-sm py-2 font-inter text-white font-[400] cut-text"
                                            dangerouslySetInnerHTML={{__html: n?.description?.en}}
                                        />
                                        <div className="fcb pt-1 pb-2 w-full">
                                            <div className="fcc">
                                        ...
                                        <div className="img flex | h-[200px] w-full flex-shrink-0 | overflow-hidden">
                                            {!n.image && (
                                                <div
                                                    ...
                                                    <Logo className="h-20 opacity-70"/>
                                                </div>
                                            )}

                                            {n.image && (
                                                <img
                                                    src={process.env.NEXT_PUBLIC_URL + "/" + n.image}
                                                    alt="new_image"
                ...
                <Link href={`/support`}>
                    <div id="touch" className="title | py-7 md:pt-20 | relative group">
                        <div className="absolute inset-0 fcc cursor-pointer">
                            <button
                                className="bg-[#F37D26] group-hover:-rotate-[30deg] group-hover:bg-white duration-500 group-hover:scale-110 w-20 h-20 md:w-32 md:h-32 fcc rounded-full mb-10">
                                <svg
                                    viewBox="0 0 96 75"
                                    fill="none"
                                    xmlns="http://www.w3.org/2000/svg"
