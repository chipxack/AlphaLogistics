                          ...
                          {props.profile ? (
                            ...
                            <div className='fc | space-x-2 md:space-x-3'>
                              {/* <button
                                ...
                                className='text-white bg-orange-primary w-1/2 py-2 text-xs md:text-sm font-bold font-poppins click:scale'
                              >
                                Registration
                              </button> */}
                              ...
                              <button
                                ...
                                className='bg-white border border-orange-primary text-orange-primary w-full py-2 text-xs md:text-sm font-bold font-poppins click:scale'
                              >
                                Log In
                              </button>
                            </div>
        ...
        >
          ...
          >
            ...
            <div className='hidden md:block md:w-1/2 | pr-5 py-5 bg-[#000000] relative overflow-hidden'>
              <div className='absolute -bottom-20 -left-20 opacity-50 w-3/4 h-full blur-2xl duration-500 rounded-[50%] bg-orange-primary'></div>
              <div className='absolute -top-20 -right-16 opacity-50 w-3/4 h-full blur-2xl duration-500 rounded-[50%] bg-orange-primary'></div>
